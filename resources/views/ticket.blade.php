			...
			<form action="/createticket" method="post">
				...
				<table>
					<tr>
						...
						<td><input type="text" name="username" placeholder="Username" class="username"></td>
					</tr>
					<tr>
						<td width="130">E-mail</td>
						<td><input type="email" name="email" placeholder="E-mail" class="email"></td>
					</tr>
					<tr>
						<td width="130">Nomor Telepon</td>
						<td><input type="text" name="no_tlpn" placeholder="No. Telp" class="no_tlpn"></td>
					</tr>
					<tr>
						<td width="130">Jumlah</td>
						<td><input type="number" name="jumlah" id="jumlah" placeholder="Jumlah" class="jumlah"></td>
					</tr>
					<tr>
						<td width="130">Waktu</td>
						<td><input type="datetime-local" name="waktu" placeholder="Waktu" class="waktu"></td>
					</tr>
					<tr>
						<td width="130">Bangku</td>
						<td><input type="text" name="bangku" placeholder="Bangku" class="bangku"></td>
					</tr>
					<tr>
						<td width="130"
